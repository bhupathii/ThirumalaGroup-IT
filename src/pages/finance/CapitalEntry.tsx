    ...
    <div className="space-y-6 p-6 max-w-7xl mx-auto select-none print:p-0">
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b border-slate-100 pb-5 no-print">
        <div>
          ...
          <h1 className="text-2xl font-black text-slate-900 tracking-tight mt-1">CAPITAL ENTRY</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 no-print">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-200 rounded-lg p-2 text-xs font-bold text-slate-800 focus:ring-1 focus:ring-slate-900 focus:outline-none shadow-sm"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    disabled={!!debit}
                    placeholder="0.00"
                    className="w-full bg-white border border-slate-200 rounded-lg p-2 text-xs font-bold text-slate-800 focus:ring-1 focus:ring-slate-900 focus:outline-none disabled:bg-slate-50 disabled:text-slate-400 shadow-sm"
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-white border border-slate-200 rounded-lg p-2 text-xs font-bold text-slate-800 focus:ring-1 focus:ring-slate-900 focus:outline-none h-9 shadow-sm"
                  />
                  <button
                    type="button"
                    onClick={() => handleBulkSubmit('Credit')}
                    disabled={bulkPosting}
                    className="inline-flex items-center justify-center px-4 py-2 text-xs font-black bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors shadow-sm disabled:opacity-50 tracking-wider"
                  >
                    CREDIT ALL
                  </button>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    disabled={bulkPosting}
                    className="inline-flex items-center justify-center px-4 py-2 text-xs font-black bg-red-650 text-white rounded-lg hover:bg-red-700 transition-colors shadow-sm disabled:opacity-50 tracking-wider"
                  >
                    DEBIT ALL
                  </button>
                </div>
          ...
          >
            {loading ? (
              <div className="flex flex-col items-center justify-center py-10 space-y-2">
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Loading capital entries...</p>
              </div>
              ...
              <div className="text-center py-12 border-2 border-dashed border-slate-200 rounded-xl space-y-3">
                ...
                <h3 className="text-xs font-black text-slate-800 uppercase tracking-wider">NO TRANSACTIONS</h3>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide max-w-xs mx-auto">
                ...
                <table className="min-w-full divide-y divide-slate-150 text-xs md:text-sm">
                  <thead>
                    <tr className="bg-slate-50/50">
                      ...
                      <th className="px-3 py-2.5 text-left font-bold text-slate-500 uppercase tracking-wider">Partner</th>
                      ...
                      <th className="px-3 py-2.5 text-left font-bold text-slate-500 uppercase tracking-wider">By</th>
                      <th className="px-3 py-2.5 text-right font-bold text-slate-500 uppercase tracking-wider">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 bg-white">
                    {entriesWithRunningBalance.map((e) => (
                      <tr key={e.id} className="hover:bg-slate-50/20">
                        ...
                        <td className="px-3 py-3 font-semibold text-slate-650 max-w-[200px] truncate" title={e.particulars || ''}>
                          {e.particulars || '—'}
                        </td>
                        <td className="px-3 py-3 text-right font-mono font-bold text-emerald-600">
                          {e.credit > 0 ? `₹${e.credit.toLocaleString('en-IN')}` : '—'}
                        </td>
                        <td className="px-3 py-3 text-right font-mono font-bold text-red-650">
                        ...
                        <td className="px-3 py-3 font-semibold text-slate-500 uppercase">
                          {e.created_by || 'STAFF'}
                        </td>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-150 rounded-xl p-5 shadow-sm">
            ...
            <div className="text-2xl font-black font-mono tracking-tight mt-1 text-emerald-600">
          ...
          <div className="bg-white border border-slate-150 rounded-xl p-5 shadow-sm">
            ...
            <div className="text-2xl font-black font-mono tracking-tight mt-1 text-red-650">
          ...
          <Card
            title={
              <div className="flex justify-between items-center w-full">
                ...
                <span className="px-1.5 py-0.5 text-[8px] font-black bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-md uppercase tracking-wider">
                  LIVE
                </span>
              </div>
            }
          ...
          >
            {loading ? (
              ...
              <div className="text-center py-10 border border-dashed border-slate-200 rounded-xl space-y-2">
                <h3 className="text-xs font-black text-slate-800 uppercase tracking-wider">NO PARTNERS</h3>
                <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wide max-w-[180px] mx-auto leading-normal">
                ...
                <table className="min-w-full text-xs">
                  <thead>
                    <tr className="border-b border-slate-100">
                      <th className="pb-2 text-left font-bold text-slate-500 uppercase tracking-wider">Partner</th>
                      <th className="pb-2 text-right font-bold text-slate-500 uppercase tracking-wider">Capital In</th>
                      <th className="pb-2 text-right font-bold text-slate-500 uppercase tracking-wider">Drawings</th>
                      <th className="pb-2 text-right font-bold text-slate-500 uppercase tracking-wider">Net Balance</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-50 bg-white">
                    {partnerBalances.map((pb) => (
                      <tr key={pb.partnerId} className="hover:bg-slate-50/30">
                        <td className="py-2.5 font-bold text-slate-850 uppercase">
                          {pb.partnerName}
                        </td>
                        <td className="py-2.5 text-right font-mono font-semibold text-emerald-600">
                          ₹{pb.capitalIn.toLocaleString('en-IN')}
                        </td>
                        <td className="py-2.5 text-right font-mono font-semibold text-red-650">
