    ...
    <div className="space-y-6 max-w-7xl mx-auto print:hidden">
      ...
      <div className="flex justify-between items-center bg-white p-4 md:p-6 rounded-xl border border-slate-200 shadow-sm">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handlePrevDay} variant="secondary" size="sm" icon={ChevronLeft} className="bg-white hover:bg-slate-50 text-slate-700 border border-slate-200" />
          <Button onClick={handleNextDay} variant="secondary" size="sm" icon={ChevronRight} className="bg-white hover:bg-slate-50 text-slate-700 border border-slate-200" />
