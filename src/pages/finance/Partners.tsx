  ...
  return (
    <div className="space-y-6 p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b border-slate-100 pb-5 mb-6">
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">PARTNERS MANAGEMENT</h1>
          <p className="text-slate-400 text-xs font-bold uppercase tracking-wider mt-1">Manage investment partners in Thirumala Group Finance</p>
        </div>
      </div>
